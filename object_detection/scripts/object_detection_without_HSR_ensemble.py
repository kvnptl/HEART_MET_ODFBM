...
class object_detection():
    def __init__(self) -> None:
        ...
        self.model_name_og = 'yolov5l.pt'
        self.model_name_day2 = 'day_3_with_all_runs.pt'
        #self.model_name_day1 = 'train_on_day1.pt'
    ...
    def _input_image_cb(self, msg):
        ...
        """
        rospy.loginfo(f"Subscriber started..{IMAGE_TOPIC}")
        try:
    ...
    def object_inference(self):
        ...
        opencv_img = self.image_queue[10]
        ...
        if (self.requested_object).lower() in detected_object_list:
            ...
            ros_image = self.cv_bridge.cv2_to_imgmsg(
                opencv_img, encoding="passthrough")
