...
class object_detection():
    def __init__(self) -> None:
        ...
        # yolo model config
        self.model_name = 'with_day_2_dataset.pt'
        self.model_name_og = 'yolov5m.pt'
        #self.model_name_toothbrush = 'toothpaste_toothbrush.pt'
    ...
    def object_inference(self):
        ...
        rospy.loginfo("[Ensemble] Object Inferencing Started...")
        ...
        ##### Only toothbrush ##############
        #auxillary_model = yolov5.load(model_path + self.model_name_toothbrush)

        print("Writing..")
        cv2.imwrite("captured_images/hsr_{}.jpg", opencv_img)
        ...
        results = np.vstack((yolo_results, ob_results))
