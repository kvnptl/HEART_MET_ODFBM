...
from metrics_refbox_msgs.msg import BoundingBox2D, ObjectDetectionResult
...
class convert_image():
    def __init__(self) -> None:
        ...
        self.output_bb_pub = rospy.Publisher("prediction_output", String, queue_size=10)    
    ...
    def object_inference(self):
        ...
        #TODO
        # if self.refereee_input in detected_object_list:
            # publish respective msgs
        ...
        for idx, value in enumerate(detected_object_list):
            ...
            # object_detection_msg.message_type = 2
            # object_detection_msg.result_type = 1
            # object_detection_msg.object_found = object_detected
            # object_detection_msg.box2d = detected_bb_list[idx]
            # object_detection_msg.image = self.image_queue[0]
        ...
        if object_detected:
            ...
            self.output_bb_pub.publish(string_msg)
